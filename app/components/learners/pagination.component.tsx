...
const Pagination = () => {
 return (
   <div className='learners-pagination divide-x divide-gray-400 md:mx-auto md:w-1/2 md:my-5 md:flex md:justify-center md:items-center'>
      <div className="learners-pagination-items md:w-1/2 flex justify-center items-center">
      ...
      <div className="learners-buttons my-5 md:my-0 px-5 flex md:w-1/2">
        <button className='min-w-fit text-white font-bold rounded-l-3xl p-2 pl-10 pr-8 bg-gradient-to-r from-sky-figma to-purple-figma'>Games (3867+)</button>
        <button className='min-w-fit text-gray-600 font-bold rounded-r-3xl p-2 border-[1px] border-gray-300'>Practice sheets (3238+)</button>
      </div>
    </div>
  )
}
